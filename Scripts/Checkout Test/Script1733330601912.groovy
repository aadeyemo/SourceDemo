...
WebUI.verifyElementText(findTestObject('Page_Swag Labs/a_5'), '5')

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/button_Checkout'))

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), 'Andrew')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'Ade')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'), '90210')

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_Cancel_continue'))

WebUI.click(findTestObject('Page_Swag Labs/div_Total 123.07'))

WebUI.verifyElementVisible(findTestObject('Page_Swag Labs/div_Total 123.07'), FailureHandling.STOP_ON_FAILURE)
